...
| Cloud Run revision | `wealth-copy-00013-wtl` (100% traffic) |
...
Verification must confirm that the public repository opens without authentication, `README.md` renders, `LICENSE` is visible, and commit `9a74c10` is in history. The URL is recorded in the root and submission READMEs, `docs/BUILD_WEEK.md`, and `07_SUBMISSION_CHECKLIST.md`.
...
6. Refresh the gallery with `09_judge_report_desktop.png` first and `10_judge_report_mobile.png` second, followed by `05_composition_detail.png`, `07_safety_stop.png`, `08_l15_terminal.png`, and `01_landing_desktop.png` if an additional image is useful.
