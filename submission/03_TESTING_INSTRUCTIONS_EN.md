...
> **Verified deployment:** the path below matches Cloud Run revision `wealth-copy-00013-wtl`, receiving 100% traffic after the final live, API-contract, privacy-boundary, desktop, and mobile smoke tests.
